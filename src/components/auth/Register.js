...
export const Register = (props) => {
    ...
    const languages = "Mandarin Chinese, Spanish, English, Hindi/Urdu, Arabic, Bengali, Portuguese, Russian, Japanese, German, Japanese, Punjabi, Wu, French, Telugu, Vietnamese, Marathi, Korean, Tamil, Italian, Turkish,Cantonese/Yue"
